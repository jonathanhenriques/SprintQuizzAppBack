...
//@Slf4j
///**
// * SpringBootTest -> anotacao para sinalizar ao spring subir o container da
// * aplicação para rodar os teste
// *
// * @SpringBootTest
// */
///**
...
//class AlternativaServiceImpTestREFCOMENTADA {
//
//	private static final long ID = 1L;
//	private static final long QUESTAO_ID = 1L;
//	private static final String TEXTO_ALTERNATIVA = "texto alternativa a";
//	private static final Logger LOGGER = LoggerFactory.getLogger(AlternativaServiceImpTestREFCOMENTADA.class);
//
//	/**
//	 * Classes consumidas no service aqui elas serão mockadas
//	 */
